...
(function(){
  ...
  /* ---------------- Mobile layout safety net ----------------
     Sets body.is-mobile from actual window width. styles.css uses this
     (with !important) as a hard guarantee that the sidebar hides and the
     mobile top bar shows on small screens, independent of whether the
     @media query itself is being applied (stale cache, etc). */
